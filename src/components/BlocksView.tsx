...
export function BlocksView({ blocks, onInteractiveExit, onDismissBlock, onBlockClick, onBlockDoubleClick, onScrollToEndRef, onLoadMore, canLoadMore, onModelClick }: BlocksViewProps & { onScrollToEndRef?: React.MutableRefObject<(() => void) | null> }) {
      ...
      case 'ai-response': {
        ...
        return (
          <div key={block.id} style={{ width: '100%' }}>
            ...
            >
              <AIResponseBlock block={block} isFocused={isFocused} onToolClick={handleToolClick} showModelInfo={showModelInfo} onModelClick={onModelClick} />
            </div>
