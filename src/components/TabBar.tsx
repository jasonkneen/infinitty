...
import { X, Plus, PanelLeft, Settings, Columns2, Rows2, Pin, Globe, Terminal, Code, File, Folder, Star, Heart, Bookmark, Home, Zap } from 'lucide-react'
...
export function TabBar({ isSidebarOpen, onToggleSidebar, onOpenSettings }: TabBarProps) {
